...
exports.XHR = exports.Request = void 0;
 ...
 * @public
 */
},{"./url.js":"node_modules/socket.io-client/build/esm/url.js","./manager.js":"node_modules/socket.io-client/build/esm/manager.js","./socket.js":"node_modules/socket.io-client/build/esm/socket.js","socket.io-parser":"node_modules/socket.io-parser/build/esm/index.js"}],"../backend/utils/movement-keys.js":[function(require,module,exports) {
"use strict";
...
var movementKeys = {
  ...
  ArrowDown: function ArrowDown(player, screen) {
    if (player.y + 1 < screen.height) player.y += 1;
  },
  ArrowRight: function ArrowRight(player, screen) {
...
var _default = movementKeys;
exports.default = _default;
},{}],"../backend/common/game.js":[function(require,module,exports) {
"use strict";
...
var _movementKeys = _interopRequireDefault(require("../utils/movement-keys.js"));
...
var Game = /*#__PURE__*/function () {
  ...
  _createClass(Game, [{
    ...
    key: "notifyAll",
    value: function notifyAll(command) {
    ...
    key: "addPlayer",
    value: function addPlayer(command) {
      var playerId = command.playerId;
      var playerX = 'playerX' in command ? command.playerX : Math.floor(Math.random() * this.state.screen.width);
      var playerY = 'playerY' in command ? command.playerY : Math.floor(Math.random() * this.state.screen.height);
    ...
    key: "removePlayer",
    value: function removePlayer(command) {
      var playerId = command.playerId;
    ...
    key: "movePlayer",
    value: function movePlayer(command) {
...
},{"../utils/movement-keys.js":"../backend/utils/movement-keys.js"}],"src/keyboard-listener.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/renderScreen.js":[function(require,module,exports) {
"use strict";
...
var renderScreen = function renderScreen(screen, game, requestAnimationFrame, currentPlayerId) {
...
var _game = _interopRequireDefault(require("../../backend/common/game.js"));

var _keyboardListener = _interopRequireDefault(require("./keyboard-listener.js"));

var _renderScreen = _interopRequireDefault(require("./renderScreen"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var socket = (0, _socket.io)('http://localhost:3000');
var game = new _game.default();
var keyboardListener = new _keyboardListener.default();
socket.on('connect', function () {
  var playerId = socket.id;
  var screen = document.getElementById('screen');
  (0, _renderScreen.default)(screen, game, requestAnimationFrame, playerId);
});
socket.on('setup', function (state) {
  var playerId = socket.id;
  game.setState(state);
  keyboardListener.registerPlayerId = playerId;
  keyboardListener.subscribe(function (command) {
    game.movePlayer(command);
    socket.emit('move-player', command);
  });
});
socket.on('add-player', function (command) {
  console.log("Receiving ".concat(command.type, " -> ").concat(command.playerId));
...
},{"socket.io-client":"node_modules/socket.io-client/build/esm/index.js","../../backend/common/game.js":"../backend/common/game.js","./keyboard-listener.js":"src/keyboard-listener.js","./renderScreen":"src/renderScreen.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
