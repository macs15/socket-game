 ...
 * @public
 */
},{"./url.js":"node_modules/socket.io-client/build/esm/url.js","./manager.js":"node_modules/socket.io-client/build/esm/manager.js","./socket.js":"node_modules/socket.io-client/build/esm/socket.js","socket.io-parser":"node_modules/socket.io-parser/build/esm/index.js"}],"src/game.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Game.prototype.notifyAll = function (key, payload) {
    for (var _i = 0, _a = this.observers; _i < _a.length; _i++) {
      var observerFunction = _a[_i];
  ...
  Game.prototype.addPlayer = function (command) {
    ...
    var playerX = 'playerX' in command ? command.playerX : Math.floor(Math.random() * this.screen.width);
    var playerY = 'playerY' in command ? command.playerY : Math.floor(Math.random() * this.screen.height);
...
},{}],"src/renderScreen.ts":[function(require,module,exports) {
"use strict";
...
var renderScreen = function renderScreen(screen, game) {
...
var renderScreen_1 = __importDefault(require("./renderScreen"));
...
(0, renderScreen_1.default)(screen, game);
},{"socket.io-client":"node_modules/socket.io-client/build/esm/index.js","./game":"src/game.ts","./renderScreen":"src/renderScreen.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
